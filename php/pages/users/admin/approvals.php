...
<body>
        ...
        <main class="dashboard-main">
            ...
            <div class="approvals-toolbar">
                <div class="search-container">
                    ...
                    <input type="text" id="searchInput" placeholder="Search by reason or target..." value="">
                </div>
    ...
    <script src="<?php echo $basePath; ?>js/serve_asset.php?file=admin_approvals.js"></script>
